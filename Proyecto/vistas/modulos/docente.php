      ...
      <div class="box-body">
        ...
        <table id="example" class="table table-bordered table-striped dt-responsive tablas" width="100%">
          ...
          <tbody>
            ...
            $clientes = ControladorDocentes::ctrMostrarDocentes($item, $valor);
            ...
            <td>
              ...
              <div class="btn-group">
                ...
                <button title="Editar" class="btn1 btn1-primary btn1-outline custom1 btnEditarCliente" data-toggle="modal" data-target="#modalEditarCliente" idCliente="' . $value["id"] . '"><i class="fa fa-edit"></i></button>
...
<div class="input-group">
  ...
  <input type="text" class="form-control input-lg" name="nuevoCorreo" placeholder="Ingresar Correo->@hotmal.com">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary custom">Guardar Docente</button>
...
<div class="input-group">
  ...
  <input type="text" class="form-control input-lg" name="editarCorreo" id="editarCorreo">
      ...
      $editarCliente = new ControladorDocentes();
      $editarCliente->ctrEditarDocente();
...
$eliminarCliente = new ControladorDocentes();
$eliminarCliente->ctrEliminarDocente();
